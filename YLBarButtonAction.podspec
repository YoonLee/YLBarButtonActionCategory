#
#  Be sure to run `pod spec lint YLBarButtonAction.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/YoonLee/YLBarButtonActionCategory.git", :tag => "1.0.0" }
